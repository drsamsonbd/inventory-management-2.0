...
<script type="text/javascript">
  ...
  methods:{
    ...
    allItem(){
    let self = this;
     axios.get('/api/items/'+ '?token='+ localStorage.getItem('token'))
 ...
 allPKU(){
    let self = this;
     axios.get('/api/pku/'+ '?token='+ localStorage.getItem('token'))
      .then(function (response) {
    ...
    onFileSelected(event){
      ...
      showModal() {
       ...
       toggleModal(id) {
         axios.get('/api/items/'+id+ '?token='+ localStorage.getItem('token'))
       ...
       viewModal(record) {
          let self = this;
            axios.get('/api/items/view/'+record.id+ '?token='+ localStorage.getItem('token'))
  	     .then(function (response) {
