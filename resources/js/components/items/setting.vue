...
//PKU
 ...
 //all   
    allCategory(){
    let self = this;
     axios.get('/api/category/'+ '?token='+ localStorage.getItem('token'))
 ...
 //  },
    allSKU(){
    let self = this;
     axios.get('/api/sku/'+ '?token='+ localStorage.getItem('token'))
      .then(function (response) {
...
//delete
       ...
       deleteCategory(id){
              ...
              if (result.value) {
                axios.delete('/api/category/'+id+ '?token='+ localStorage.getItem('token'))
               .then(() => {
                this.allCategory();
   ...
   // },
        deleteSKU(id){
              ...
              if (result.value) {
                axios.delete('/api/sku/'+id+ '?token='+ localStorage.getItem('token'))
               .then(() => {
                this.allSKU();
...
// show insert modal
 ...
 // show update modal
       toggleModal(id) {
         axios.get('/api/category/'+id+ '?token='+ localStorage.getItem('token'))
 ...
 //    },
      toggleModalSKU(id) {
         axios.get('/api/sku/'+id+ '?token='+ localStorage.getItem('token'))
 ...
 //insert  
       categoryInsert(){
       axios.post('/api/category'+ '?token='+ localStorage.getItem('token'),this.form)
       .then(() => { 
  ...
  //     },
         skuInsert(){
        axios.post('/api/sku'+ '?token='+ localStorage.getItem('token'),this.formsku)
        .then(() => { 
 ...
 //update       
     categoryUpdate(){
       ...
       axios.patch('/api/category/'+id+ '?token='+ localStorage.getItem('token'),this.forms)
       .then(() => { 
  ...
  SKUUpdate(){
       ...
       axios.patch('/api/sku/'+id+ '?token='+ localStorage.getItem('token'),this.formskus)
       .then(() => { 
