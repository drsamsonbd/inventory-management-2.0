...
//Aktiviti
 ...
 //all   
   ...
   allaktiviti(){
  let self = this;
   axios.get('/api/finance/activity'+ '?token='+ localStorage.getItem('token'))
    .then(function (response) {
    ...
    allol(){
    let self = this;
     axios.get('/api/ol/'+ '?token='+ localStorage.getItem('token'))
      .then(function (response) {
...
//delete
     ...
     deleteaktiviti(id){
            ...
            if (result.value) {
              axios.delete('/api/finance/activity/'+id+ '?token='+ localStorage.getItem('token'))
             .then(() => {
              this.allaktiviti();
      ...
      deleteol(id){
              ...
              if (result.value) {
                axios.delete('/api/ol/'+id+ '?token='+ localStorage.getItem('token'))
               .then(() => {
                this.allol();
...
// show insert modal
 ...
 // show update modal
       ...
       toggleModalaktiviti(id) {
        axios.get('/api/finance/activity/'+id+ '?token='+ localStorage.getItem('token'))
 	    .then(({data}) => (this.formas = data))
       this.$refs['aktiviti-update-modal'].toggle('#aktiviti-toggle-btn')       
     },
      toggleModalol(id) {
         axios.get('/api/ol/'+id+ '?token='+ localStorage.getItem('token')) 
 ...
 //insert  
       ...
       this.$refs['category-insert-modal'].hide('#insert-btn')  
        ...
        aktivitiInsert(){
        axios.post('/api/finance/activity'+ '?token='+ localStorage.getItem('token'),this.forma)
        .then(() => { 
        ...
        olInsert(){
        axios.post('/api/ol'+ '?token='+ localStorage.getItem('token'),this.formol)
        .then(() => { 
 ...
 //update       
     categoryUpdate(){
      ...
      aktivitiUpdate(){
       ...
       axios.patch('/api/finance/activity/'+id+ '?token='+ localStorage.getItem('token'),this.formas)
       .then(() => { 
  ...
  olUpdate(){
       ...
       axios.patch('/api/ol/'+id+ '?token='+ localStorage.getItem('token'),this.formols)
       .then(() => { 
